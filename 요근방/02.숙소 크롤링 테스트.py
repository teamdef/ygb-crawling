...
# 검색어 입력창
pyautogui.moveTo(2354, 624)
pyautogui.click()
accname = driver.find_element(By. CSS_SELECTOR, "#_pcmap_list_scroll_container > ul > li:nth-child(1) > div.ouxiq.icT4K > a:nth-child(1) > div > div > span.place_bluelink.YwYLL")
accname.click()
